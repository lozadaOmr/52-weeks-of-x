...
and `function destroyer(arr) {};` to which in Python you would simply just `def destroyer(arr, *args):`
 
Had to really take a look at the documentation and read.
